...
% readmylisp_to_formal_MLC('(+ (+ (+ (+ (* S1 -22.19) (* (* (+ (* S0 -5770) -3924) (* S1 -22.19)) (* S1 S0))) (* S0 -6474)) (+ (* S0 -6474) (* (* (* -7789 (* S0 -6474)) (* S1 -22.19)) (* (* (+ (* S1 -22.19) -3924) (* S1 -22.19)) (* S1 S0))))) (+ (* S1 -22.19) (* (* -5898 S0) (* S1 -22.19))))')
% syms S0 S1
% expand    simplify   vpa(ans)
...
parameters.maxdepth = 8;%15;%15;
parameters.maxdepthfirst = 4;%8;%8;
...
parameters.problem_variables.dt=0.0005;%0.001;%0.001;
