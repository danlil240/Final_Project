...
%Type mlc=MLC('parameters_evaluator_not_lin5Z') to create corresponding MLC object
% mlc.go(n)   mlc.go(50,1)
% mlc.show_best
% mlc.show_ind(n2);  man(n2) = mlc.table.number;
% readmylisp_to_formal_MLC('(+ (* -2000 S0) (+ (* S0 -5654) (* S1 -47.2)))')
% syms S0 S1
% expand    simplify
...
parameters.evaluation_function='evaluator_not_lin5Z';
