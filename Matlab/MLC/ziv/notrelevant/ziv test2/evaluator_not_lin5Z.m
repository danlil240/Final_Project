function J=evaluator_not_lin5(ind,parameters,i,fig)
...
try
    ...
    f=@(T,Y) Dynamic_model_not_lin5Z(Y,b(Y(1:2)),Q,R,Tevmax);
...
%  m1='-247.7*S0 -5.418*S1';
 m1='-3999.7*S0 -23.4*S1';
    ...
    f=@(T1,Y1) Dynamic_model_not_lin5Z(Y1,b1(Y1(1:2)),Q,R,100);
    opts = odeset('RelTol',1e-11,'AbsTol',1e-14);
