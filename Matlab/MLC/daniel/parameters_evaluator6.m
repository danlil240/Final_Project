...
%  mlc=MLC('parameters_evaluator6')
% mlc.go(n)   mlc.go(50,1)
% mlc.show_best
% mlc.show_ind(n2);  man(n2) = mlc.table.number;
% readmylisp_to_formal_MLC('(+ (* -2.251 S1) (* S0 -4.924))')
% syms S0 S1
% expand    simplify
...
parameters.evaluation_function='evaluator6';
