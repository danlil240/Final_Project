...
%Type mlc=MLC('parameters_evaluator3') to create corresponding MLC object
...
parameters.range = 10;%10000;
parameters.precision = 4;
parameters.opsetrange = [1 3];%[1 2 3];
parameters.formal = 0;
parameters.end_character = '';
parameters.maxdepth = 15;%2;%15;
parameters.maxdepthfirst = 8;%2;%8;
...
parameters.evaluation_function='evaluator3';
...
parameters.problem_variables.Q=diag([22000 0.1]);%Q=diag([1000 0.5]);%
parameters.problem_variables.dt=0.00001;%0.001;
