% G:\MY DRIVE\ZIV\SCE\PROJECT PROPOSALS\OCTOBER 2021\פיתוח אלגוריתם בקרה מבוסס מכונה לומדת לדיכוי רעידות במערכת דרגת חופש אחת\MATLAB\MLC\ZIV\SAVE_GP\20211224-0823\SCRIPT parameters scropt for MLC
% Type mlc=MLC('G:\My Drive\ziv\SCE\Project proposals\October 2021\פיתוח אלגוריתם בקרה מבוסס מכונה לומדת לדיכוי רעידות במערכת דרגת חופש אחת\Matlab\MLC\ziv\save_GP\20211224-0823\script') to create corresponding MLC object
...
parameters.savedir = 'G:\My Drive\ziv\SCE\Project proposals\October 2021\פיתוח אלגוריתם בקרה מבוסס מכונה לומדת לדיכוי רעידות במערכת דרגת חופש אחת\Matlab\MLC\ziv\save_GP\20211224-0823';
