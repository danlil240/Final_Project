% G:\MY DRIVE\ZIV\SCE\PROJECT PROPOSALS\OCTOBER 2021\פיתוח אלגוריתם בקרה מבוסס מכונה לומדת לדיכוי רעידות במערכת דרגת חופש אחת\MATLAB\MLC\ZIV\SAVE_GP\20211225-2214\SCRIPT parameters scropt for MLC
% Type mlc=MLC('G:\My Drive\ziv\SCE\Project proposals\October 2021\פיתוח אלגוריתם בקרה מבוסס מכונה לומדת לדיכוי רעידות במערכת דרגת חופש אחת\Matlab\MLC\ziv\save_GP\20211225-2214\script') to create corresponding MLC object
...
parameters.evaluation_function = 'evaluator_not_lin5';
...
parameters.savedir = 'G:\My Drive\ziv\SCE\Project proposals\October 2021\פיתוח אלגוריתם בקרה מבוסס מכונה לומדת לדיכוי רעידות במערכת דרגת חופש אחת\Matlab\MLC\ziv\save_GP\20211225-2214';
